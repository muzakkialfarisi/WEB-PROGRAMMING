<div class="main">
        <section class="section section-tabs" style="background: linear-gradient(0deg, rgba(44, 44, 44, 0), rgba(204, 201, 192,1));">
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow border-0">
                            <div class="card-body px-lg-5 py-lg-5">
                                ...
                                <?php echo form_open('LoginAdmin/ubahsiswa_proses'); ?>
                                    <div class="row">
                                        <!-- Atribut Master -->
                                        <div class="col-md-6">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" name="submit" class="btn btn-primary mt-4" href="<?= base_url(); ?>LoginAdmin/ubahsiswa?>">Ajukan</button>
                                    </div>
